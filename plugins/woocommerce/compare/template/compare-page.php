            ...
            if (empty($product_list)) {
                ...
                <tr>
                    ...
                    foreach ($images as
                            ...
                            $image) {
                        ?>
                        <td data-product-id="<?php echo $id ?>"><?php echo $image ?></td>
                        <?php
                    }
                    ?>
                </tr>   
                <tr>
                    ...
                    foreach ($names as
                            ...
                            $name) {
                        ?>
                        <td data-product-id="<?php echo $id ?>"><?php echo $name; ?></td>
                        <?php
                    }
                    ?>
                </tr>  
                <tr>
                    ...
                    foreach ($prices as
                            ...
                            $price) {
                        ?>
                        <td data-product-id="<?php echo $id ?>"><?php echo $price; ?></td>
                        <?php
                    }
                    ?>
                </tr>
                ...
                foreach ($attrs as
                    ...
                    <tr>
                        ...
                        foreach ($attr["values"] as
                                ...
                                $value) {
                            ?>
                            <td data-product-id="<?php echo $id ?>"> <?php echo $value; ?></td>
                            <?php
                        }
                        ?>
                    </tr>
                ...
                <tr>
                    ...
                    foreach ($views as
                            ...
                            $view) {
                        ?>
                        <td data-product-id="<?php echo $id ?>"><?php echo $view; ?></td>
                        <?php
                    }
                    ?>
                </tr>
                <tr>
                    ...
                    foreach ($removes as
                            ...
                            $remove) {
                        ?>
                        <td data-product-id="<?php echo $id ?>"><?php echo $remove; ?></td>
                        <?php
                    }
                    ?>
                </tr>
