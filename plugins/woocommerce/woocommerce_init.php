...
define("WOO_PLUGIN_URL", TEMPLATEURL . "/plugins/woocommerce");
/* ----------------------------------------------------------------------------------- */
/* Wishlist   */
/* ----------------------------------------------------------------------------------- */
require_once dirname(__FILE__) . "/wish-list/wish-list.php";
require_once dirname(__FILE__) . "/compare/compare.php";
if (class_exists('Woocommerce')) {
    /* ----------------------------------------------------------------------------------- */
    /* Ajax   */
    /* ----------------------------------------------------------------------------------- */
    add_ajax('remove_product', 'as_remove_product_from_cart');
    add_ajax('as_quick_view', 'as_load_product_quick_view');
    ...
    function as_woo_enqueue_scripts() {
        if (!function_exists('is_woocommerce_activated')) {
            ...
            add_script('as-woocommerce', get_template_directory_uri() . '/js/woocommerce.js', array(
                "jquery"), false, true);
            add_script('as-elevatezoom', get_template_directory_uri() . '/js/libs/jquery.elevatezoom.js', array(
                "jquery"), false, true);
        }
    }
    ...
    function as_load_product_quick_view() {
        ...
        wc_get_template('quick-view.php', array(), '', TEMPLATE_DIR . '/woocommerce/cart/');
