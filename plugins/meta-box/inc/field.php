...
if (!class_exists('RWMB_Field ')) {
    ...
    class RWMB_Field {
        ...
        static function show($field, $saved) {
            ...
            $meta        = call_user_func(array(
                $field_class,
                'meta'), $post->ID, $saved, $field);
            ...
            $outer_html = sprintf(
                    $field['before'] . '<div class="%s">%s</div>' . $field['after'], implode(' ', $classes), $html
            );
        ...
        static function begin_html($meta, $field) {
            ...
            return sprintf(
				...
				<div class="rwmb-input">', $field['id'], $field['name']
            );
        }
        ...
        static function end_html($meta, $field) {
            $button = $field['clone'] ? call_user_func(array(
                        RW_Meta_Box::get_class_name($field),
                        'add_clone_button'), $field) : '';
