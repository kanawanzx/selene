    ...
    class RWMB_Image_Field extends RWMB_File_Field {
        ...
        static function admin_enqueue_scripts() {
            ...
            wp_enqueue_script('rwmb-image', RWMB_JS_URL . 'image.js', array(
                'jquery-ui-sortable'), RWMB_VER, true);
        }
        ...
        static function add_actions() {
            ...
            add_action('wp_ajax_rwmb_reorder_images', array(
                __CLASS__,
        ...
        static function get_uploaded_images($images, $field) {
            ...
            $html          = sprintf(
                    $ul, implode(' ', $classes), $field['id'], $delete_nonce, $reorder_nonce, $field['force_delete'] ? 1 : 0, $field['max_file_uploads']
            );
        ...
        static function img_html($image) {
            ...
            return sprintf(
                    $li, $image, $src, $i18n_edit, $link, $i18n_edit, $i18n_delete, $image
            );
        }
