    ...
    class RWMB_File_Input_Field extends RWMB_Field {
        ...
        static function html($meta, $field) {
            return sprintf(
				...
				<a href="#" class="rwmb-file-input-remove button %s">%s</a>', $field['field_name'], $field['id'], $meta, $field['placeholder'], $field['size'], __('Select', 'meta-box'), $meta ? '' : 'hidden', __('Remove', 'meta-box')
            );
        }
