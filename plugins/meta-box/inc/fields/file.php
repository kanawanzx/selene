    ...
    class RWMB_File_Field extends RWMB_Field {
        ...
        static function html($meta, $field) {
            ...
            $html .= sprintf(
				...
				</div>', implode(' ', $new_file_classes), $i18n_title, $field['id'], $i18n_more
            );
        ...
        static function get_uploaded_files($files, $field) {
            ...
            $html      = sprintf(
                    $ol, implode(' ', $classes), $field['id'], $delete_nonce, $reorder_nonce, $field['force_delete'] ? 1 : 0, $field['max_file_uploads'], $field['mime_type']
            );
        ...
        static function file_html($attachment_id) {
            ...
            return sprintf(
                    $li, $attachment_id, wp_get_attachment_image($attachment_id, array(
                60,
                60), true), wp_get_attachment_url($attachment_id), get_the_title($attachment_id), $mime_type, $i18n_edit, get_edit_post_link($attachment_id), $i18n_edit, $i18n_delete, $attachment_id, $i18n_delete
            );
        }
        ...
        static function value($new, $old, $post_id, $field) {
            ...
            foreach ($files as
                    $file_item) {
                $file = wp_handle_upload($file_item, array(
                    'test_form' => false));
