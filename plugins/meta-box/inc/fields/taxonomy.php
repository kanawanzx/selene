    ...
    class RWMB_Taxonomy_Field extends RWMB_Field {
        ...
        static function admin_enqueue_scripts() {
            ...
            wp_enqueue_script('rwmb-taxonomy', RWMB_JS_URL . 'taxonomy.js', array(
                ...
                'wp-ajax-response'), RWMB_VER, true);
        }
        ...
        static function normalize_field($field) {
            ...
            if (in_array($field['options']['type'], array(
                        'checkbox_tree',
                        'select_tree'))) {
        ...
        static function walk_checkbox_tree($meta, $field, $elements, $parent = 0, $active = false) {
            ...
            foreach ($terms as
                    $term) {
                $html .= sprintf(
                        $li, $field['field_name'], $term->term_id, checked(in_array($term->term_id, $meta), true, false), $term->name
                );
