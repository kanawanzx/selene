...
jQuery(document).on('click', '.as_quickview_btn', function (e) {
    ...
    jQuery.magnificPopup.open({
        ...
        items: {
            src: '<div id="as-product-quickview" class="as-product-quickview-wrapper woocommerce mfp-with-anim"><span class="as-ajax-loading-img"><img src="' + template_path + '/img/woocommerce/ajax-loader@2x.gif"></span></div>',
            type: 'inline',
            midClick: true
        },
        callbacks: {
