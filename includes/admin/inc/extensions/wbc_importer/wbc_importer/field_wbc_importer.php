    ...
    class ReduxFramework_wbc_importer {
        ...
        public function render() {
            ...
            if (!empty($this->field['wbc_demo_imports'])) {
                ...
                foreach ($this->field['wbc_demo_imports'] as
                        $section =>
                        $imports) {
                    ...
                    if (false == $imported) {
                        ...
                        wbc_extended_example($demo_active_import, $demo_directory_path);
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-wbc-importer-js', $this->extension_url . '/field_wbc_importer.js', array(
                'jquery'), time(), true
            );
